...
import com.norana.numberplace.ui.activity.MakeActivity;
import com.norana.numberplace.ui.activity.PlayActivity;
import com.norana.numberplace.ui.activity.SavedActivity;

public class ConfirmSolveDialogFragment extends DialogFragment {

    public ConfirmSolveDialogFragment(){}
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        else if (activity instanceof MakeActivity)
            style = R.style.AlertStyleBlue;
        ...
        builder.setMessage(R.string.dialog_realy_solve)
                .setPositiveButton(R.string.yes,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (activity instanceof PlayActivity){
                                    ((PlayActivity) activity).solveSudoku();
                                }
                                else if (activity instanceof MakeActivity){
                                    ((MakeActivity) activity).solveSudoku();
                                }
                                else if (activity instanceof SavedActivity)
                                    ((SavedActivity) activity).solveSudoku();
                            }
                        })
